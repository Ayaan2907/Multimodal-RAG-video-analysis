...
description: Whenever working on a NextJS, javascript, typescript, Nodejs, React, fullstack web applicaiton projects
---
  ...
  - Prefer 'pnpm' over npm unless found a package-lock.json in the directory.
